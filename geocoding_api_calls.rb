...
# address = venue_addresses[1]
# url = "https://maps.googleapis.com/maps/api/geocode/json?address=#{address}&key=AIzaSyATP_zi5GjdL_qkgcyO56rm15V-r3veiKY"
# serialized = open(url).read
# address_serialized = JSON.parse(serialized)
# address_serialized = JSON.neat_generate(JSON.parse(serialized))
...
# puts JSON.neat_generate(venues_with_coords)


puts VENUE_COORDINATES